/*globals define, it, expect, jasmine, describe*/
/*jslint nomen: true */
        ...
        function expectValidMonster(monster) {
            describe(monster.name + ' at ' + monster.x + ',' + monster.y, function () {
                ...
                for (variable in types) {
                    if (types.hasOwnProperty(variable)) {
            ...
            describe('Initialized Model (Seed ' + model._getSeed() + ')', function () {
                ...
                describe('Tiles', function () {
                    ...
                    for (key in model.tiles) {
                        if (model.tiles.hasOwnProperty(key)) {
                            expectValidTile(key);
                        }
                    }
                });
                ...
                describe('Walls', function () {
                    var key;
                    for (key in model.walls) {
                        if (model.walls.hasOwnProperty(key)) {
                            expectValidWall(key);
                        }
                    }
                });
